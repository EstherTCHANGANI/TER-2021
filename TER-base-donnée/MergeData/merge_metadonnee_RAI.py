...
def merge_data_mongodb(file_name_fiche, file_name_meta, champs):
    ...
    file_name_fiche_2 = pd.read_csv('../Import/Data/MetaDonnees/MetaDonnées_RAI.csv')
...
if __name__ == "__main__":
    file_name = "../Import/Data/Fiches/fiches_RAIUNO 20.csv"
    fiche_name = "../Import/Data/Fiches/Fiches RAIUNO 1330.csv"
